...
SECRET_KEY = 'django-insecure-d@9)0j5x(89bnkt569d%*d+4679i^e05@-_zzdx#qr8(z1ujqq'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gmycom',       # Remplacez par le nom de votre base MySQL
        'USER': 'root',       # Ex. : 'root'
        'PASSWORD': '',  # Laissez vide si vous n'en avez pas
        'HOST': 'localhost',
        'PORT': '3306',
        'OPTIONS': {
